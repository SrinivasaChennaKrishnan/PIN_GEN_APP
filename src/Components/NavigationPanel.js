            ...
            <React.Fragment>
                <Container>
                    <Row className={Classes.tabsRow}>
                        <Col xs lg={{ span: 2, offset: 1 }} className={isGenerateActive ? Classes.activeTab : Classes.generateTabClass}><Link id="generateTab" onClick={this.generateTabClick} to="/">Generate</Link></Col>
                        <Col xs lg={{ span: 2, offset: 2 }} className={isSavedActive ? Classes.activeSavedTab : Classes.savedTabClass}><Link id="savedTab" onClick={this.savedTabClick} to="/SavedPinList">Saved</Link></Col>
                    </Row>
                </Container>
            </React.Fragment>
        );
